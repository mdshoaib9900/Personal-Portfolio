...
export default function Contact() {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center bg-gray-100 px-4 py-10">
      ...
      {/* Contact Form */}
      <form className="w-full max-w-2xl bg-white p-6 sm:p-8 rounded-2xl shadow-lg flex flex-col gap-4">
        <input
          type="text"
        ...
        <button
          type="submit"
          className="bg-black text-white font-bold py-3 px-6 rounded-xl hover:scale-105 transition-transform duration-200"
        >
          Send Message
        </button>
      </form>
      ...
      <div className="mt-10 flex gap-6">
        ...
        <a href="mailto:youremail@example.com" className="hover:scale-110 transition-transform duration-200">
          <EmailIcon />
        </a>
      </div>
    </section>
